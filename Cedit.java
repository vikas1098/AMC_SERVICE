...
public class Cedit extends javax.swing.JFrame {
 Connection con;
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(718, 50));
        ...
        setSize(new java.awt.Dimension(718, 670));
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                tacode.setText(rs.getString(9));
               amcf.setText(rs.getString(7));
                amct.setText(rs.getString(8));
            }
            else
            {}
        }
    ...
    private void btnupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupActionPerformed
        try
        {
            ...
            String amcfr=amcf.getText();
            String amcto=amct.getText();

            st.execute("update customer set name='"+name+"',phone="+phone+",email='"+email+"',area='"+area+"',city='"+city+"',citycode='"+acode+"',amcfrom='"+amcfr+"',amcto='"+amcto+"' where code="+code+"");
